    ...
    function load_post() {
        ...
        jQuery.ajax({
            ...
            data: {
                ...
                post_type: '<?php if (!empty($post_type)): echo implode(",", $post_type);
endif; ?>',
                display_postid_ar: '<?php if (!empty($display_postid_ar)): echo implode(",", $display_postid_ar);
endif; ?>',
                displayed_sub_cat_ar: '<?php if (!empty($displayed_sub_cat_ar)): echo implode(",", $displayed_sub_cat_ar);
endif; ?>',
                sub_catid_ar: '<?php if (!empty($subcat_id_ar)): echo implode(",", $subcat_id_ar);
endif; ?>',
