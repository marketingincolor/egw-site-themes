...
/*
  Class: DiscussionIconCollections
...
class DiscussionIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new DiscussionIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new DiscussionIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new DiscussionIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new DiscussionLineaIcons('Linea Icons', 'linea_icon'));
    }
    ...
    public function getIconCollectionIcons(iDiscussionIconCollection $collection) {
...
$discussion_IconCollections = DiscussionIconCollections::get_instance();