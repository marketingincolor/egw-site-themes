<?php
namespace Discussion\Modules\Separator;
...
class Separator implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map(
			array(
				'name' => esc_html__('Mikado Separator', 'discussionwp'),
				'base' => $this->base,
				'category' => 'by MIKADO',
	...
	public function render($atts, $content = null) {
		...
		$html = discussion_get_shortcode_module_template_part('templates/separator-template', 'separator', '', $params);
	...
	private function getSeparatorStyle($params) {
		...
		if ($params['width'] !== '') {
			if(discussion_string_ends_with($params['width'], '%') || discussion_string_ends_with($params['width'], 'px')) {
		...
		if ($params['top_margin'] !== '') {
			if(discussion_string_ends_with($params['top_margin'], '%') || discussion_string_ends_with($params['top_margin'], 'px')) {
		...
		if ($params['bottom_margin'] !== '') {
			if(discussion_string_ends_with($params['bottom_margin'], '%') || discussion_string_ends_with($params['bottom_margin'], 'px')) {
