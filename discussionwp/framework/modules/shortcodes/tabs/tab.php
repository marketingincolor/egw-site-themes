<?php
namespace Discussion\Modules\Tab;
...
class Tab implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Mikado Tab', 'discussionwp'),
			'base' => $this->getBase(),
	...
	public function render($atts, $content = null) {
		...
		$output = '';
		$output .= discussion_get_shortcode_module_template_part('templates/tab_content','tabs', '', $params);
		return $output;
	}
}