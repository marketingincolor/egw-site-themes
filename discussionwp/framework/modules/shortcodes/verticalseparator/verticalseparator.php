<?php
namespace Discussion\Modules\VerticalSeparator;
...
class VerticalSeparator implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html = discussion_get_shortcode_module_template_part('templates/vertical-sep-template', 'verticalseparator', '', $params);
	...
	private function getSeparatorStyle($params) {
		...
		if ($params['height'] !== '') {
			$sep_style[] = 'height: '.discussion_filter_px($params['height']).'px';
		}

		if ($params['margin_left'] !== '') {
			$sep_style[] = 'margin-left: '.discussion_filter_px($params['margin_left']).'px';
		}

		if ($params['margin_right'] !== '') {
			$sep_style[] = 'margin-right: '.discussion_filter_px($params['margin_right']).'px';
		}

		if ($params['bottom_offset'] !== '') {
			$sep_style[] = 'margin-bottom: '.discussion_filter_px($params['bottom_offset']).'px';
		}
