<?php
namespace Discussion\Modules\Shortcodes\Button;
 ...
 * @package Discussion\Modules\Shortcodes\Button
 */
class Button implements ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(array(
            'name'                      => esc_html__('Mikado Button', 'discussionwp'),
            'base'                      => $this->base,
            'category'                  => 'by MIKADO',
            'admin_enqueue_css' => array(discussion_get_skin_uri().'/assets/css/mkd-vc-extend.css'),
            ...
            'params'                    => array_merge(
                ...
                discussion_icon_collections()->getVCParamsArray(array(), '', true),
                array(
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => 'Color',
                    ...
                    array(
                        ...
                        'value'       => array_flip(discussion_get_font_weight_array(true)),
                        'admin_label' => true,
                        'group'       => 'Design Options',
                    ),
                    array(
                        ...
                        'heading'     => 'Margin',
                        'param_name'  => 'margin',
                        'description' => esc_html__('Insert margin in format: 0px 0px 1px 0px', 'discussionwp'),
                        'admin_label' => true,
                        'group'       => 'Design Options'
                    ),
                    array(
                        ...
                        'group'       => 'Icon Options',
                        'description' => 'Will only influence solid type'
                    ),
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => 'Hover Background Color',
                        ...
                        'admin_label' => true,
                        'dependency'  => array('element' => discussion_icon_collections()->iconPackParamName, 'not_empty' => true),
                        'group'       => 'Icon Options',
                        'description' => 'Will only influence solid type'
                    ),
                )
    ...
    public function render($atts, $content = null) {
        ...
        return discussion_get_shortcode_module_template_part('templates/'.$params['html_type'], 'button', $params['hover_animation'], $params);
    }
    ...
    private function getButtonStyles($params) {
        ...
        if(!empty($params['background_color']) && ($params['type'] !== 'outline' && $params['type'] !== 'transparent')) {
        ...
        if(!empty($params['font_size'])) {
            $styles[] = 'font-size: '.discussion_filter_px($params['font_size']).'px';
        }
