 ...
 */
class DiscussionPostLayoutSeven extends DiscussionWidget {
    /**
     * Set basic widget options and call parent class construct
     */
    public function __construct() {
        parent::__construct(
            'mkd_post_layout_seven_widget', // Base ID
            'Mikado Post Layout Seven Widget' // Name
        );
    ...
    public function widget($args, $instance) {
        ...
        $instance['custom_thumb_image_width'] = $instance['custom_thumb_image_width'] != '' ? $instance['custom_thumb_image_width'] : '117';
        $instance['custom_thumb_image_height'] = $instance['custom_thumb_image_height'] != '' ? $instance['custom_thumb_image_height'] : '86';
        ...
        echo '<div class="widget mkd-plw-seven">';
        ...
        echo do_shortcode("[mkd_post_layout_seven $params]"); // XSS OK
