 ...
 */
class DiscussionSocialIconWidget extends DiscussionWidget {
    /**
    ...
    protected function setParams() {
        $this->params = array_merge(
            discussion_icon_collections()->getSocialIconWidgetParamsArray(),
            array(
                array(
                    'type' => 'textfield',
                    'title' => 'Link',
    ...
    public function widget($args, $instance) {
        ...
        <a class="mkd-social-icon-widget-holder" <?php echo discussion_get_inline_attr($hover_color, 'data-hover-color'); ?> <?php discussion_inline_style($social_icon_styles) ?> href="<?php echo esc_html($link); ?>" target="<?php echo esc_attr($target); ?>">
