...
if ( ! function_exists('discussion_contact_form_7_options_map') ) {

	function discussion_contact_form_7_options_map() {
		...
		$panel_contact_form_style_1 = discussion_add_admin_panel(array(
		...
		$typography_text_group = discussion_add_admin_group(array(
		...
		$typography_text_row1 = discussion_add_admin_row(array(
		...
		$typography_text_row2 = discussion_add_admin_row(array(
		...
		$typography_text_row3 = discussion_add_admin_row(array(
		...
		$typography_label_group = discussion_add_admin_group(array(
		...
		$typography_label_row1 = discussion_add_admin_row(array(
		...
		$typography_label_row2 = discussion_add_admin_row(array(
		...
		$background_border_group = discussion_add_admin_group(array(
		...
		$background_border_row1 = discussion_add_admin_row(array(
		...
		$background_border_row2 = discussion_add_admin_row(array(
		...
		$background_border_row3 = discussion_add_admin_row(array(
		...
		$padding_group = discussion_add_admin_group(array(
			'name'			=> 'padding_group',
		...
		$padding_row = discussion_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		$margin_group = discussion_add_admin_group(array(
			'name'			=> 'margin_group',
		...
		$margin_row = discussion_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = discussion_add_admin_group(array(
		...
		$button_typography_row1 = discussion_add_admin_row(array(
		...
		$button_typography_row2 = discussion_add_admin_row(array(
		...
		$button_background_border_group = discussion_add_admin_group(array(
		...
		$button_background_border_row1 = discussion_add_admin_row(array(
		...
		$button_background_border_row2 = discussion_add_admin_row(array(
		...
		$button_background_border_row3 = discussion_add_admin_row(array(
		...
		$panel_contact_form_style_2 = discussion_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
	...
	add_action( 'discussion_options_map', 'discussion_contact_form_7_options_map', 15);
}