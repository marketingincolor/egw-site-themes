...
if ( ! function_exists('discussion_mobile_header_options_map') ) {

	function discussion_mobile_header_options_map() {

		$panel_mobile_header = discussion_add_admin_panel(array(
			'title' => 'Mobile header',
	...
	add_action( 'discussion_after_header_options_map', 'discussion_mobile_header_options_map');
