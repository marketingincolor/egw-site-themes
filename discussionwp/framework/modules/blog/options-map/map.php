...
if ( ! function_exists('discussion_blog_options_map') ) {

	function discussion_blog_options_map() {
		...
		$panel_blog_lists = discussion_add_admin_panel(
			array(
				'page' => '_blog_page',
		...
		$category_unique_layout_container = discussion_add_admin_container(
			array(
		...
		$author_unique_layout_container = discussion_add_admin_container(
			array(
		...
		$tag_unique_layout_container = discussion_add_admin_container(
			array(
		...
		$pagination_container = discussion_add_admin_container(
			array(
		...
		$blog_list_feature_image_container = discussion_add_admin_container(
			array(
		...
		discussion_add_admin_field(array(
			...
			'type'          => 'yesno',
			'label'         => 'Show Count',
			'description'   => 'Enabling this option will show count post info on your blog page.',
			'parent'        => $panel_blog_lists,
			'default_value' => 'yes'
		));
		 ...
		 * Blog Single
		 */
		$panel_blog_single = discussion_add_admin_panel(
			array(
				'page' => '_blog_page',
		...
		discussion_add_admin_field(
			array(
				...
				'label' => 'Featured Image Max Width',
				'parent' => $panel_blog_single,
				'description' => 'Define maximum width for featured image on single post pages. Default value is 1300',
				'args' => array(
					'col_width' => 3
				)
			)
		...
		$related_image_container = discussion_add_admin_container(
			array(
		...
		discussion_add_admin_field(
			array(
				...
				'description' => 'Define maximum width for related posts images on your single post pages. Default value is 800',
				'args' => array(
					'col_width' => 3
				)
			)
		...
		$blog_single_navigation_container = discussion_add_admin_container(
			array(
		...
		$blog_single_author_info_container = discussion_add_admin_container(
			array(
	...
	add_action( 'discussion_options_map', 'discussion_blog_options_map', 11);
}