<?php
namespace Discussion\Modules\Blog\Shortcodes\BlockSix;

use Discussion\Modules\Blog\Shortcodes\Lib\ListShortcode;
/**
 * Class BlockSix
 */
class BlockSix extends ListShortcode
{
    ...
    public function __construct() {
        $this->base = 'mkd_block_six';
        $this->css_class = 'mkd-pb-six';
        $this->shortcode_title = 'Mikado Block 6';
    ...
    public function render($atts, $content = null) {
        ...
        if ($atts['query_result']->have_posts()):
            ...
            endwhile;
            $html .= '</div>'; // close mkd-pb-six-featured
