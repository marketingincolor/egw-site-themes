<?php
namespace Discussion\Modules\Blog\Shortcodes\BlockSeven;
...
class BlockSeven extends ListShortcode
{
    ...
    public function __construct() {
        $this->base = 'mkd_block_seven';
        $this->css_class = 'mkd-pb-seven';
        $this->shortcode_title = 'Mikado Block 7';
    ...
    public function render($atts, $content = null) {
        ...
        if ($atts['query_result']->have_posts()):
            ...
            endwhile;
            $html .= '</div>'; // close mkd-pb-seven-featured
