...
$video_post_format_meta_box = discussion_add_meta_box(
	array(
		'scope' =>	array('post'),
...
$mkd_video_embedded_container = discussion_add_admin_container(
	array(
		'parent' => $video_post_format_meta_box,
...
$mkd_video_self_hosted_container = discussion_add_admin_container(
	array(
		'parent' => $video_post_format_meta_box,
