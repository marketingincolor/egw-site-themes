...
if ( ! function_exists('discussion_social_options_map') ) {

	function discussion_social_options_map() {
		 ...
		 * Enable Social Share
		 */
		$panel_social_share = discussion_add_admin_panel(array(
			'page'  => '_social_page',
		...
		$panel_show_social_share_on = discussion_add_admin_panel(array(
			'page'  			=> '_social_page',
		 ...
		 */
		$panel_social_networks = discussion_add_admin_panel(array(
			'page'  			=> '_social_page',
		 ...
		 * Facebook
		 */
		discussion_add_admin_section_title(array(
		...
		$enable_facebook_share_container = discussion_add_admin_container(array(
		...
		$enable_twitter_share_container = discussion_add_admin_container(array(
		...
		$enable_google_plus_container = discussion_add_admin_container(array(
		...
		$enable_linkedin_container = discussion_add_admin_container(array(
		...
		$enable_tumblr_container = discussion_add_admin_container(array(
		...
		$enable_pinterest_container = discussion_add_admin_container(array(
		...
		$enable_vk_container = discussion_add_admin_container(array(
		...
		if(defined('MIKADO_TWITTER_FEED_VERSION')) {
            $twitter_panel = discussion_add_admin_panel(array(
                'title' => 'Twitter',
                'name'  => 'panel_twitter',
                'page'  => '_social_page'
            ));

            discussion_add_admin_twitter_button(array(
                'name'   => 'twitter_button',
        ...
        if(defined('MIKADO_INSTAGRAM_FEED_VERSION')) {
            $instagram_panel = discussion_add_admin_panel(array(
                'title' => 'Instagram',
                'name'  => 'panel_instagram',
                'page'  => '_social_page'
            ));

            discussion_add_admin_instagram_button(array(
	...
	add_action( 'discussion_options_map', 'discussion_social_options_map', 12);
