<div class="mkd-page-header page-header clearfix">
    ...
    <div class="mkd-theme-name pull-left" >
        <img src="<?php echo esc_url(discussion_get_skin_uri() . '/assets/img/logo.png'); ?>"
        ...
        <div class="mkd-top-section-holder-inner">
            ...
            <div class="mkd-top-buttons-holder">
                <?php if($showSaveButton) { ?>
                    <input type="button" id="mkd_top_save_button" class="btn btn-info btn-sm" value="<?php esc_html_e('Save Changes', 'discussionwp'); ?>"/>
                <?php } ?>
            </div>
        </div>
    </div>
