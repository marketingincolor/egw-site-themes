...
class MikadoSkin extends DiscussionSkinAbstract {
    /**
     * Skin constructor. Hooks to discussion_admin_scripts_init and discussion_enqueue_admin_styles
     */
    public function __construct() {
        $this->skinName = 'mikado';

        //hook to
        add_action('discussion_admin_scripts_init', array($this, 'registerStyles'));
        add_action('discussion_admin_scripts_init', array($this, 'registerScripts'));

        add_action('discussion_enqueue_admin_styles', array($this, 'enqueueStyles'));
        add_action('discussion_enqueue_admin_scripts', array($this, 'enqueueScripts'));

        add_action('discussion_enqueue_meta_box_styles', array($this, 'enqueueMetaStyles'));
        add_action('discussion_enqueue_meta_box_scripts', array($this, 'enqueueScripts'));
    ...
    public function registerScripts() {
        ...
        foreach ($this->scripts as $scriptHandle => $scriptPath) {
            discussion_register_skin_script($scriptHandle, $scriptPath);
        }
    }
    ...
    public function registerStyles() {
        ...
        foreach ($this->styles as $styleHandle => $stylePath) {
            discussion_register_skin_style($styleHandle, $stylePath);
        }
    ...
    public function renderOptions() {
        ...
        $tab    		= discussion_get_admin_tab();
        $active_page 	= $discussion_Framework->mkdOptions->getAdminPageFromSlug($tab);
     ...
     *
*@param DiscussionAdminPage $page current page to load
...
*@param DiscussionAdminPage $page current page to load
    ...
    public function renderImport() { ?>
        <div class="mkd-options-page mkd-page">
            <?php $this->getHeader(discussion_get_theme_info_item('Name'), discussion_get_theme_info_item('Version'), false); ?>
            <div class="mkd-page-content-wrapper">
                <div class="mkd-page-content">
                    <div class="mkd-page-navigation mkd-tabs-wrapper vertical left clearfix">
