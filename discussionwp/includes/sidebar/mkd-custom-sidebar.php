...
if( ! class_exists('DiscussionSidebar') ){
	
	class DiscussionSidebar{
		...
		function __construct(){
			...
			$this->title = esc_html__('Custom Widget Area','discussionwp');
		...
		function template_add_widget_field(){
			...
			echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '".esc_html__('Enter Name of the new Widget Area', 'discussionwp')."' name='mkd-add-widget' /></span>";
			echo "\n    <input class='button' type='submit' value='".esc_html__('Add Widget Area', 'discussionwp')."' />";
			echo "\n    ".$nonce;
			echo "\n  </form>";
			echo "\n</script>\n";
		}
		...
		function register_custom_sidebars(){
			...
			$args = apply_filters('discussion_custom_widget_args', $args);
