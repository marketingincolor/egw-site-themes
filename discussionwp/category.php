<?php
$blog_archive_pages_classes = discussion_blog_archive_pages_classes(discussion_get_category_blog_list());
?>
<?php get_header(); ?>
...
<?php do_action('discussion_after_container_open'); ?>
	<div class="<?php echo esc_attr($blog_archive_pages_classes['inner']); ?>">
		<?php discussion_get_blog(discussion_get_category_blog_list()); ?>
	</div>
